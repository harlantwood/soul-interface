...
import { Currency, JSBI, Percent, Router, 
  SwapParameters, Token,  
  Trade as LegacyTrade, 
  TradeType,
  TridentTrade} from 'sdk'
import { useMemo } from 'react'
import { BIPS_BASE, INITIAL_ALLOWED_SLIPPAGE } from '../constants'
import { useTransactionAdder } from '../state/transactions/hooks'
import { calculateGasMargin, isZero, 
  isAddress, shortenAddress } from 'functions'
import { getMarginRouterContract, useFactoryContract } from 'hooks/useContract'
...
function useSwapCallArguments(
  trade: LegacyTrade<Currency, Currency, TradeType> | undefined, // trade to execute, required
  marginTrade: boolean,
