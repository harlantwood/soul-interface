...
// import './Swap.css'
import { ChainId, CoinKey, Token, ChainKey, findDefaultToken } from '@lifi/types'
...
import {
  ...
  storeRoute,
} from 'features/crosschain/services/localStorage'
import { switchChain as switchChainMetaMask } from 'features/crosschain/services/metamask'
import { useStomt } from 'features/crosschain/services/stomt'
import { loadTokenListAsTokens } from 'features/crosschain/services/tokenListService'
import {
  deepClone,
  formatTokenAmount,
  ...
  getBalance,
  isWalletDeactivated,
} from 'features/crosschain/services/utils'
import {
  getChainById,
  getChainByKey,
  Order,
...
const Swap = () => {
  ...
  useEffect(() => {
    if (tokensAndChainsSet) {
      ...
      const startParams = getDefaultParams('', availableChains, tokens)
