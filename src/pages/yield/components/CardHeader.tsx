...
export function BorrowCardHeader({ children }: any) {
    return <CardHeader className="bg-dark-900 border-b-8 border-pink">{children}</CardHeader>
}

export function LendCardHeader({ children }: any) {
    return <CardHeader className="bg-blue-dark border-b-8 border-blue">{children}</CardHeader>
}