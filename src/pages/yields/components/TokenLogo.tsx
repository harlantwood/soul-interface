...
const getTokenLogoURL = (address: string, chainId: any) => {
    ...
    if (chainId === ChainId.ETHEREUM) {
        imageURL = `https://raw.githubusercontent.com/SoulSwapFinance/assets/master/blockchains/etherum/assets/${isAddress(
            address
        )}/logo.png`
    }  else {
        imageURL = `https://raw.githubusercontent.com/SoulSwapFinance/assets/master/blockchains/fantom/assets/${isAddress(
            address
        )}/logo.png`
    }
